        ...
        <div class="row">
            <div class="col-lg-2 mb-4">
                <div class="list-group">
                    ...
                    <a href="<?=ADMIN;?>/cache" class="list-group-item list-group-item-action border-0 rounded active">Cache</a>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td>Shop menu</td>
                                <td>Shop menu on the site. Cached for 1 hour</td>
                                <td class="text-center"><a href="<?=ADMIN;?>/cache/delete?key=category" class="delete"><i class="fas fa-trash text-danger"></i></a></td>
                            </tr>
                            <tr>
                                <td>Filter menu</td>
                                <td>Filter menu on the site. Cached for 1 hour</td>
                                <td class="text-center"><a href="<?=ADMIN;?>/cache/delete?key=filter" class="delete"><i class="fas fa-trash text-danger"></i></a></td>
                            </tr>
                            <tr>
                                <td>Test name</td>
                                <td>Test description</td>
                                <td class="text-center"><a href="<?=ADMIN;?>/cache/delete?key=test" class="delete"><i class="fas fa-trash text-danger"></i></a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
